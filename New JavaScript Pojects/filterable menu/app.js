//get only unique categories - hardestOne
...
window.addEventListener('DOMContentLoaded', function(){
     ...
     //what is something changes and we need to add more feature to the menu
    ...
    //to add categories to button
    let categoriesBtns = categories.map(function(category){
          return `<button class="filter-btn" type="button" data-name=${category}>
                      ${category}</button>`
    })
    categoriesBtns = categoriesBtns.join('')
        // console.log(categoriesBtns)
        btnContainer.innerHTML = categoriesBtns
       console.log(btnContainer)
       //working the btns Now
...
//we use this function to add items dynamically
